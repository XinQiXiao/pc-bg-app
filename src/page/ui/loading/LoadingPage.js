...
class LoadingPage extends Component{
	...
	render(){
		...
		return (
			<div >
				<Card title="Spin使用" className="ui-card-wrap">
					<Spin size="small"/>
					<Spin style={{margin: '0 10px'}}/>
					<Spin size="large"/>
				</Card>
				<Card title="自定义Spin图片" className="ui-card-wrap">
					<Spin indicator={iconLoading} style={{marginRight: 10}}/>
					<Spin indicator={iconPlus} style={{marginRight: 10}} spinning={true}/>
				</Card>
				<Card title="内容遮罩" className="ui-card-wrap">
				...
				<Card title="自定义描述文案" className="ui-card-wrap">
					<Spin tip="loading..."/>
				</Card>
			</div>
		)
